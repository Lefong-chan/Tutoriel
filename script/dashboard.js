(function () {
  ...
  var _ctxInviteFromFriends = false;
  ...
  document.querySelectorAll('.game-type-btn').forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      closeModal(gameSelectModal);
      if (gameOrigin === 'create') {
        matchupData = null;
        openGameSetup(selectedGame, null);
      } else if (gameOrigin === 'room' && matchupData) {
  ...
  var receiverIsReady = true;

  var _handledRoomEvents = new Set();

  var roomFriendInviteTimers = {};
  var roomFriendInviteIds = {};
